...
const file = process.argv[2] || 'file:///D:/mypy/speech-lab/wave-anim/index.html';
const out = process.argv[3] || 'D:/mypy/speech-lab/wave-anim/tools/shot.png';
const full = /full/.test(out);
const wait = parseInt(process.argv[4] || '2600', 10);
const port = 9400 + Math.floor(Math.random() * 300);
const profile = 'D:/mypy/speech-lab/wave-anim/tools/.cdp-' + port;
