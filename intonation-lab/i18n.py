...
EN: dict[str, str] = {
    ...
    "还没有音节框：请先用侧边栏“音节自动切分”或手动标注。": "No syllable boxes yet: use “Auto-segment syllables” in the sidebar, or annotate by hand.",
    ...
    "⏱ 时长调节": "⏱ Duration",
    "应用": "Apply",
    "音节自动切分": "Auto-segment syllables",
    "按声调提取特征点": "Extract by tone",
